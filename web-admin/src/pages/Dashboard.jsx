    ...
    <div style={{ display: 'flex', minHeight: '100vh', position: 'relative' }}>
      ...
      <aside style={{
        ...
        <nav style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 4 }}>
          ...
          {/* Super Admin nav (solo para emails autorizados) */}
            ...
            <>
              ...
              <button onClick={() => setActiveNav('admin')}
                style={{
                  display: 'flex', alignItems: 'center', gap: 10,
                  padding: '11px 12px', borderRadius: 10, border: 'none',
                  background: activeNav === 'admin' ? 'rgba(255,92,58,0.12)' : 'transparent',
                  color: activeNav === 'admin' ? '#FF5C3A' : '#7070A0',
                  cursor: 'pointer', fontFamily: 'DM Sans, sans-serif',
                  fontSize: 14, fontWeight: activeNav === 'admin' ? 600 : 400,
                  textAlign: 'left', transition: 'all 0.15s',
                  boxShadow: activeNav === 'admin' ? 'inset 0 0 0 1px rgba(255,92,58,0.2)' : 'none',
                }}
                onMouseOver={e => activeNav !== 'admin' && (e.currentTarget.style.background = 'rgba(255,255,255,0.04)', e.currentTarget.style.color = '#F0F0FF')}
                onMouseOut={e => activeNav !== 'admin' && (e.currentTarget.style.background = 'transparent', e.currentTarget.style.color = '#7070A0')}
              >
                <IconShield />
                Super Admin
              </button>
      ...
      <main style={{ flex: 1, padding: '32px 36px', position: 'relative', zIndex: 1, overflow: 'auto' }}>
        ...
        {activeNav === 'admin' && <SuperAdminPage />}
      </main>
    </div>
  )
}
